        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: '1 1 0' }}>
            <Card className={classes.cardroot}>
                <CardContent>
                    ...
                    <Typography color="textSecondary">
                        ...
                        <Link to='/analyzation'> <Button size="large">Explore!</Button></Link>
                </CardContent>
            ...
            <Card className={classes.cardroot}>
                <CardContent>
                    ...
                    <Typography color="textSecondary" >
                        ...
                        <Button size="large">Read More</Button>
                        <Link to='/recommendation'><Button size="large">Explore!</Button></Link>
            ...
            <Card className={classes.cardroot}>
                <CardContent>
                    ...
                    <Button size="large">Read More</Button>
                        <Link to='/diseasedetection'><Button size="large">Explore!</Button></Link>
